...
easy_words = ['ALBANIA', 'ALGERIA', 'ANDORRA', 'ANGOLA', 'ARMENIA',
              'AUSTRIA', 'BAHAMAS', 'BAHRAIN', 'BELARUS', 'BELGIUM',
              'BELIZE', 'BENIN', 'BHUTAN', 'BOLIVIA', 'BOTSWANA',
              'BRAZIL', 'BRUNEI', 'CANADA', 'CHAD', 'CHILE', 'CHINA',
              'CROATIA', 'CUBA', 'CYPRUS', 'DENMARK', 'DJIBOUTI', 'ECUADOR',
              'EGYPT', 'ESTONIA', 'ESWATINI', 'ETHIOPIA', 'FIJI', 'FINLAND',
              'FRANCE', 'GABON', 'GAMBIA', 'GEORGIA', 'GHANA', 'GREECE',
              'GRENADA', 'GUINEA', 'GUYANA', 'HAITI', 'HUNGARY',
              'ICELAND', 'INDIA', 'IRAN', 'IRAQ', 'ISRAEL', 'ITALY',
              'JAMAICA', 'JAPAN', 'JORDAN', 'KENYA', 'KOSOVO', 'KUWAIT',
              'LAOS', 'LATVIA', 'LEBANON', 'LESOTHO',
              'LIBERIA', 'LIBYA', 'MALAWI', 'MALI', 'MALTA', 'MEXICO',
              'MONACO', 'NAMIBIA', 'NAURU', 'NEPAL', 'NIGER', 'OMAN',
              'PALAU', 'PANAMA', 'PERU', 'POLAND', 'QATAR', 'ROMANIA',
              'RUSSIA', 'RWANDA', 'SAMOA', 'SERBIA', 'SINGAPORE', 'SLOVAKIA',
              'SOMALIA', 'SPAIN', 'SUDAN', 'SWEDEN', 'SYRIA', 'TAIWAN',
              'TOGO', 'TONGA', 'TUNISIA', 'TURKEY', 'TUVALU', 'UGANDA',
              'UAE', 'USA', 'URUGUAY', 'VIETNAM', 'YEMEN', 'ZAMBIA']

medium_words = ['AFGHANISTAN', 'ARGENTINA', 'AUSTRALIA', 'AZERBAIJAN',
                'BANGLADESH', 'BARBADOS', 'BULGARIA', 'BURUNDI',
                'CAMBODIA', 'CAMEROON', 'COLOMBIA', 'COMOROS',
                'COSTA-RICA', 'DOMINICA', 'EQUATORIAL GUINEA',
                'ERITREA', 'GUATEMALA', 'GUINEA-BISSAU', 'HONDURAS',
                'INDONESIA', 'IVORY-COAST', 'KAZAKHSTAN', 'KYRGYZSTAN',
                'LIECHTENSTEIN', 'LITHUANIA', 'LUXEMBOURG', 'MADAGASCAR',
                'MALAYSIA', 'MALDIVES', 'MICRONESIA', 'MOLDOVA', 'MONGOLIA',
                'MOROCCO', 'MOZAMBIQUE', 'MYANMAR', 'NETHERLANDS',
                'NICARAGUA', 'NIGERIA', 'NORWAY', 'PAKISTAN', 'PARAGUAY',
                'PHILIPPINES', 'PORTUGAL', 'SAINT-LUCIA', 'SAN-MARINO',
                'SAUDI-ARABIA', 'SENEGAL', 'SEYCHELLES', 'SIERRA-LEONE',
                'SLOVENIA', 'SRI-LANKA', 'SURINAME', 'SWITZERLAND',
                'TAJIKISTAN', 'TANZANIA', 'THAILAND', 'TURKMENISTAN',
                'UKRAINE', 'UZBEKISTAN', 'VANUATU',
                'VENEZUELA', 'ZIMBABWE']

hard_words = ['ANTIGUA-AND-BARBUDA', 'BOSNIA-AND-HERZEGOVINA',
              'BURKINA-FASO', 'CENTRAL-AFRICAN-REPUBLIC',
              'CZECH-REPUBLIC', 'DOMINICAN-REPUBLIC', 'EAST-TIMOR',
              'EL-SALVADOR', 'MARSHALL-ISLANDS', 'MAURITANIA', 'MAURITIUS',
              'NEW-ZEALAND', 'NORTH-MACEDONIA', 'NORTH-KOREA',
              'PAPUA-NEW-GUINEA', 'SOUTH-AFRICA', 'SOUTH-KOREA', 'SOUTH-SUDAN',
